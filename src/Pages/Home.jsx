...
export default function Home() {
    ...
    let [amenities_image_path,setAminityImgPath]=useState('')
    ...
    let [aminityData, setAminityData] = useState([])
    ...
    let homePageData = () => {
        axios.post(BaseUrl + '/home')
            ...
            .then((finalRes) => {
                ...
                setAminityData(fData.getFeaturedProjects.amenities);
                                                    ...
                                                    <div className="row mb-4">
                                                        ...
                                                        <div className="col-lg-7 col-xl-6 px-md-3">
                                                                    ...
                                                                    <div class="ashaProLeft">
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <h2 class="text-capitalize fw-500 fs-30 mb-0 ms-2">
                                                                                <a href="/residential/ashapurna-kundan-villa">{featue.name}</a>
                                                                            </h2>
                                                                        </div>
                                                                        <div class=" text-white lh-24 fs-14 line-clamp-4 mt-3 mb-4">{featue.short_description}</div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                {featue.amenities.slice(0,3).map((am,ami)=>{
                                                                    return(<div class="col-xl-4 col-md-4 col-sm-4 col-6">
                                                                    <div class="facilityBlocks d-flex align-items-start ">

                                                                        <div class="facilityIcon me-2 me-md-3">

                                                                            <img src={amenities_image_path+am.image} width="36" alt="SWIMMING" />
                                                                        </div>
                                                                        <div class="facilityIconContent">
                                                                            <h4 class="golden-color mb-1">{am.title}</h4>
                                                                            <span class="text-white">{am.sub_title}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>)
                                                                })}
                                    ...
                                    <div class="testimonialBlock position-relative bg-white pb-5 px-2 px-lg-5">
                                        <div class="d-flex mb-0 mb-md-4">
                                            ...
                                            <div class="testimonialInfo pt-3">
                                                <h5 class="golden-color text-capitalize mb-1">Mr Damodar Prajapat</h5>
                                                <span class="text-color d-block mb-1">Ashapurna Anmol</span>
                                            </div>
                                        </div>
                                        <div class="blueColor-2 fw-400 fs-15 lh-24">Being a customer of Ashapurna Buildcon Ltd. makes me happy. The experience was excellent. To ensure swift and easy process, they were always attentive, responsive, and went above and beyond to help us not as a client ut as a family member.</div>
                            ...
                            <Slider {...medialSlider}>
                                ...
                                <div class="projects-wrapper pb-2 bg-white h-100" >
                                    <div class="text-center position-relative">
                                        <img src="https://d3qnldyv492i08.cloudfront.net/ashapurna/images/utsav_camps/event-thumbnail-1698994445.webp" class="img-fluid ashapaImg" />
                                        <div class="projectHeading ps-2 ps-lg-3 position-relative ">
                                            <h3 class="text-start my-3">
                                                <a class="light-blue-color fw-600 cursor-pointer fs-17 line-clamp-1" href="">Dandiya Night Celebration At Ashapurna Heritage</a>
                                            </h3>

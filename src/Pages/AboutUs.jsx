                    ...
                    <div className="row">
                        <div class="col-lg-6">
                            <div class="aboutMainLeft text-center">
                                <img src="https://d3qnldyv492i08.cloudfront.net/ashapurna/images/about_us/ashapurna-buildcon-corporate-office-1681628091.webp" class="img-fluid" alt="Ashapurna Buildcon Corporate Office 3d image" />
                            </div>
                        </div>

                        <div class="col-lg-6">
                            <div class="aboutmain-right pt-4 pt-lg-0 ps-0 ps-lg-3">
                                <span class="text-uppercase golden-color subtitle subtitle-bgtext position-relative pe-3">About Us</span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-6">
                                        <div class="aboutFeatureBlock text-center mb-5 mb-md-0">
                                            <div class="aboutfeatureIcon bg-white d-flex align-items-center justify-content-center rounded-1 mx-auto mb-20">
                                                <img src="https://d3qnldyv492i08.cloudfront.net/ashapurna/images/about_us/experience-check.svg" alt="Years Of Experience" />
                                            </div>
                                            ...
                                            <h6 class="text-white fs-16 text-capitalize">Years Of Experience</h6>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-6">
                                        <div class="aboutFeatureBlock text-center mb-5 mb-md-0">
                                            ...
                                            <h6 class="text-white fs-16 text-capitalize">Projects Completed</h6>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-6">
                                        <div class="aboutFeatureBlock text-center mb-0 mb-md-0">
                                            ...
                                            <h6 class="text-white fs-16 text-capitalize">Happy Families</h6>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-6">
                                        <div class="aboutFeatureBlock text-center mb-0 mb-md-0">
                                ...
                                <div class="m-0 align-items-center row">
                                    <div class="p-0 col-lg-4">
                                        <div class="ourmission-image mb-3 mb-lg-0 text-center">
                                            <img src="https://d3qnldyv492i08.cloudfront.net/ashapurna/images/about_us/ourvision.png" alt="Our Vision" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="pe-0 col-lg-8">
                                        <div class="ourmissionContent d-flex py-lg-3 py-xl-0 align-items-center h-100">
                                            <div class="ps-2 pe-1">
                                                <h3 class="light-blue-color position-relative fs-22 fw-600 text-uppercase">Our Vision</h3>
                                                <div class="text-color fw-400 mb-0 lh-24 fs-14"><p>To be a leader and most preferred real estate name in Rajasthan by constantly striving hard to put innovation and futuristic perspective in every fine detail of designing and execution.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="ourMission bg-white py-3 py-lg-0 ms-lg-1 mb-3 mb-lg-0">
                                <div class="m-0 align-items-center row">
                                    <div class="p-0 col-lg-4">
                                        <div class="ourmission-image mb-3 mb-lg-0 text-center">
                                            <img src="https://d3qnldyv492i08.cloudfront.net/ashapurna/images/about_us/ourmission.png" alt="Our Mission" class="img-fluid" />
                                        </div>
                                    </div>
                                    <div class="pe-0 col-lg-8">
                                        <div class="ourmissionContent d-flex py-lg-3 py-xl-0 align-items-center h-100">
                                            <div class="ps-2 pe-1">
                                                <h3 class="light-blue-color position-relative fs-22 fw-600 text-uppercase">Our Mission</h3>
                    ...
                    <div class="row">
                        <div class="ms-auto col-lg-7 col-md-8">
                            <div class="achievementContent bg-white position-relative p-4">
                                <h3 class="blue-color fw-600 mb-3">Our Achievement</h3>
                                <div class="lh-24 fs-14 text-color">
                                    <p className='text-justify'>“Indian Leadership Award for Infrastructure Development 2011” for Outstanding Contribution in the Field of Infrastructure Development to Shri Karan Singh Uchiyarda, Chairman &amp; Managing Director, Ashapurna Buildcon by “Indian Economic Development &amp; Research Association, New Delhi”</p>
                                    <p className='text-justify'>Dignitaries Present: Dr. Bhishma Narayan Singh, Former Governor, Tamil Nadu; Dr. GVG Krishnamoorti, Former Chief Election Commissioner, Government of India and Jogendra Singh, Former CBI Director</p>
                                </div>
                            </div>
                        </div>
                    </div>
